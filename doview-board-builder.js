...
/*
DoView Board Builder V1.1.0
Public release: 2026-05-08
...
const BUILDER_VERSION = 'V1.1.0';
const EXPECTED_FILENAME_RE = /^[a-z0-9][a-z0-9-]*_doview-board_v\d+\.\d+\.\d+\.\d+_\d{4}-\d{2}-\d{2}\.html$/;

const SIMPLE_DEFAULT_VIEW_SETTINGS = {
  thisThen: { showCounts: false, showTrafficLights: false, showPriorities: false, showHowCounts: false, showMeasures: false, showEvalQuestions: false, showMainText: false, showLateralHow: false, showTags: false },
  how: { showNumbering: false, showTrafficLights: false, showPriorities: false, showWhyCounts: false, showLateralHow: false, showMeasures: false, showEvalQuestions: false, showMainText: false, showTags: false },
  finalOutcomes: { showTrafficLights: false, showPriorities: false, showMeasures: false, showEvalQuestions: false, showMainText: false, showTags: false }
};
...
function usage() {
  return [
    ...
    '    --out labour-2026-nz-election_doview-board_v1.1.0_2026-05-08.html',
    '',
    'Inputs:',
...
function normalizeConfig(cfg) {
  ...
  ['thisThen', 'how', 'finalOutcomes'].forEach(function (section) {
    if (!isPlainObject(out.savedState.viewSettings[section])) out.savedState.viewSettings[section] = simpleDefaultViewSettings()[section];
  });
  return out;
}
...
function main() {
  ...
  const cfg = parseConfig(configText, args.config);
